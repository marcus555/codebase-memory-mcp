...
extern const unsigned char _binary_assets_index_EpP58jrS_js_data[];
extern const unsigned int _binary_assets_index_EpP58jrS_js_size;
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    ...
    {"/assets/index-EpP58jrS.js", _binary_assets_index_EpP58jrS_js_data, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[1].size = _binary_assets_index_EpP58jrS_js_size;
